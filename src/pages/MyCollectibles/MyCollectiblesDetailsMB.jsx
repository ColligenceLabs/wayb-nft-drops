            ...
            <div className="collectibles-details-wp">
                <div className="product-details">
                    ...
                    <div className="details-box">
                        ...
                        <div className="description-label"> The only thing better than ice cream is ice cream in SPACE!</div>
                        ...
                        <div className="list-item">
                            ...
                            <div className="item">
                                <div className="label" data-qa-component="token-type-label">Token Type</div>
                                <div className="value" data-qa-component="token-type-value">erc721</div>
                            </div>
                            <div className="item">
...
export default MyCollectiblesDetailsMB;
