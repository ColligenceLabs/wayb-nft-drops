        ...
        <div className="price-collection-view-page">
          <div className="price-collection-box">
            ...
            <div className="token-details-box">
              ...
              <div>
                <div className="">
                  Commemorate the Bucks Round 1 series victory over the Chicago
                  Bulls in the 2022 NBA Playoffs with the first deer of the Fear
                  The Deer Win Club…the Chicago Deer!
                </div>
              </div>
              <div>
              ...
              <div>
                <div className="box-price-collection">
                  <div className="box-price-detail-collection">
                    ...
                    <div className="lable-bottom fw-600">50</div>
                  </div>
                  <div className="box-price-detail-collection">
