...
import PurChaseMB from './PurchaseHistoryMB';
				...
				<div className="purchase-history-body">
					<div className="purchase-history-content">
						<div className="table-row heading-row">
							<div className='title purchase_date'>
								Date
					...
					<div className="purchase-history-content">
						<div className="table-row">
							...
							<div className='value nft'>
								<a className='campaign_name' href='#'>Racecarpop 4</a>
								<Link to="/series" className='name'>It's a race to the finish! This Pop is raring to go fourth.</Link>
							</div>
							...
							<div className="icon value">
								...
								<svg 
									...
									xmlns="http://www.w3.org/2000/svg" >
										<path d="M16 16H2V2H9V0H2C0.89 0 0 0.9 0 2V16C0 17.1 0.89 18 2 18H16C17.1 18 18 17.1 18 16V9H16V16ZM11 0V2H14.59L4.76 11.83L6.17 13.24L16 3.41V7H18V0H11Z" fill="black"></path>
								</svg>
								</a>
							</div>
						</div>
					...
					<div className="purchase-history-content">
						<div className="table-row">
							...
							<div className='value payment_type'>Web Purchase</div>
							<div className='value nft'>
								<a className='campaign_name' href='#'>Be Rewarded !</a>
								<Link to="/series" className='name'>Strawberry Shortcake Space Creampop # 49</Link>
							</div>
					...
					<div className="purchase-history-content">
						<div className="table-row">
							...
							<div className='value payment_type'>Web Purchase</div>
							<div className='value nft'>
								<a className='campaign_name' href='#'>Ketchupop!</a>
								<Link to="/series" className='name'>Let's ketchup some time! It's been too long...</Link>
							</div>
