              ...
              <div className="wrapper-sounhong">
                ...
                <div className="about-sounhong">
                  ...
                  <div className="about-sidescape">
                    ...
                    issues. His artwork exhibition was displayed in the National
                    Museum of Modern and Contemporary Art, Korea, Seoul Museum
                    of Art, Gyeonggi Museum of Art, Ho-Am Museum of Art, Ecole
                    National Superieure des Beaux-Arts, Paris, France, and the
        ...
        <div className="section-02">
          <div className="wrapper-header">
            ...
            <div className="content-header">
              Each canvas has its own unique story to tell. Collect 91 canvases
              containing the artist's story with NFT. A portion of this NFT
              proceeds will be donated to animal rights organizations
            </div>
          </div>
          <div className="wrapper-bottom">
            ...
            <div className="wrapper-infor-nft">
              ...
              <ul>
                <li>
                  {' '}
                  Each NFT costs $11 and can be purchased with cryptocurrency or
                  mobile payments!
                </li>
                <li>
                  A total of 10 collections consisting of a total of 91 NFTs are
                  sold.
                </li>
                <li>
                  You cannot specify a specific NFT at the time of purchase, you
                  will receive each NFT randomly after purchase.
                </li>
                <li>
