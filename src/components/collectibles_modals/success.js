...
export default ({ close }) => (
    <div class="modal_collectibles" tabindex="-1" role="dialog" aria-modal="true">
        <div class="contents flex" data-qa-component="send-to-matic-modal-box">
            ...
            <div class="text_sending">
                <a class="purple_text">&nbsp;Strawberry Shortcake Space Creampop #49&nbsp;</a>is on its way to 0xF3e34e...f478670B20</div>
            <hr size={1} width={'80%'} color={'#363433'}></hr>
            <div class="text_small">It may takes a few hours to show up in your interval wallet. Please email us at <a class="purple_text">support@sweet.io</a> if you have any question.</div>
            <div class="understand">
                <Link to={'/my-collectibles'} class="link">
                    <button onClick={close} class="understand_button" data-qa-component="continue-button">Go to My Wallet</button>
                </Link>
            </div>
        </div>
    </div>
