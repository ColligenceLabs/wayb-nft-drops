...
const DialogWalletsMb = ({showWalletsMb, onHideWalletsMb, onHideSidebar}) => {
  return (
    <ReactModal
      preventScroll={true}
      isOpen={showWalletsMb}
      contentLabel="onRequestClose Example"
      onRequestClose={onHideWalletsMb}
      className="Modal"
      overlayClassName="dialog-wallets-overlay"
      shouldCloseOnOverlayClick
    >
      <div className="dialog-wallets-mb">
        <div className="wrapper-header">
          <div className="title">
            <img src={wallet} alt="icon wallet" />
            <div>My Wallets</div>
          </div>
          <div className="close-button button" onClick={onHideWalletsMb}>
        ...
        <div className="wrapper-accounts">
          <button className="account-item button" onClick={onHideWalletsMb}>
...
export default DialogWalletsMb