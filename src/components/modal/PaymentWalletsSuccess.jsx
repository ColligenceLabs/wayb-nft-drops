        ...
        <div className="modal-content">
          ...
          <div className='modal-body'>
            ...
            <div className="content-payment-modal-success">
              ...
              <div className="content">Congratulations, your token purchase is in progress, It could take up to ten minutes to verify your transaction and transfer the token to your wallet.</div>
            </div>
            <button type="submit" className='payments-btn-submit fw-600' onClick={onHide}>Got It!</button>
